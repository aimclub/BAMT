...
def get_proximity_matrix(df, df_coded, proximity_metric) -> pd.DataFrame:
    """Returns matrix of proximity matrix of the dataframe, dataframe must be coded first if it contains categorical data
...
def get_brave_matrix(df, proximity_matrix, n_nearest=5) -> pd.DataFrame:
